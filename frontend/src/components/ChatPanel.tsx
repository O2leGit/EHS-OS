  ...
  return (
    <div className="fixed right-0 top-0 h-full w-full sm:w-[380px] bg-navy-900 border-l border-navy-700 flex flex-col z-40">
      ...
      <div className="flex items-center justify-between p-4 border-b border-navy-700">
        ...
        <button onClick={onClose} className="w-8 h-8 flex items-center justify-center rounded-lg bg-navy-800 hover:bg-red-900/50 text-gray-400 hover:text-red-400 transition-colors" title="Close chat">
